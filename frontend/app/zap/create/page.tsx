...
function useAvailableActionsAndTriiggers(){
...
//Notable omission: Error handling for failed API requests could be added for production readiness in above

const ZAPSA=()=>{
    const router =useRouter();
    const {availableActions,availableTriggers}=useAvailableActionsAndTriiggers();
    ...
    return <div>
        ...
        <div className="w-full ,min-h-screen bg-slate-200 flex flex-xol justify-center">
            ...
            <div className="w-full pt-2 pb-2">
                {selectedActions.map((action,index)=><div className="pt-2 flex justify-center" key={index}><ZapCell onClick={()=>{
